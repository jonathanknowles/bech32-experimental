...
prop_fromWord5List_toWord5List words =
  Payload.toWord5List (Payload.fromWord5List words) === words

prop_fromWord8List_toWord8List :: [Word8] -> Property
prop_fromWord8List_toWord8List words =
  Payload.toWord8List (Payload.fromWord8List words) === Just words

prop_toText_fromText :: Payload -> Property
prop_toText_fromText payload =
  Payload.fromText (Payload.toText payload) === Right payload
...
prop_toWord5List_fromWord5List d =
